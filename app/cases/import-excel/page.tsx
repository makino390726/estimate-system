...
export default function ImportExcelPage() {
  ...
  const [customHeaderRow, setCustomHeaderRow] = useState<string>('1')
  const [customStartRow, setCustomStartRow] = useState<string>('2')
  const [customEndRow, setCustomEndRow] = useState<string>('100')
  ...
  const handlePreview = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ★カスタム範囲指定がONなら送信
      if (useCustomRange) {
        formData.append('customHeaderRow', customHeaderRow)
        formData.append('customStartRow', customStartRow)
        formData.append('customEndRow', customEndRow)
      }
  ...
  return (
    <>
      {stage === 'confirm' && confirmData ? (
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '30px', fontFamily: 'system-ui', minHeight: '100vh', backgroundColor: '#ffffff', color: '#1a1a1a' }}>
          <button
          ...
          <h1 style={{ color: '#1a1a1a', fontSize: '28px', marginBottom: '30px', fontWeight: 'bold' }}>📋 見積書のインポート（プレビュー・マッピング機能付き）</h1>

          {/* ========== ステージ1: アップロード ========== */}
          {stage === 'upload' && (
            <form onSubmit={handlePreview} style={{ marginTop: '20px' }}>
              <div style={{ marginBottom: '28px' }}>
                <label htmlFor="file" style={{ display: 'block', marginBottom: '12px', fontWeight: 'bold', color: '#1a1a1a', fontSize: '16px' }}>
                ...
                />
                {file && (
                  <p style={{ marginTop: '12px', color: '#555', fontWeight: '500', fontSize: '15px' }}>
              ...
              <div style={{ marginTop: '28px' }}>
                <label style={{ display: 'block', marginBottom: '12px', fontWeight: '600', color: '#1a1a1a', fontSize: '16px' }}>
                  📋 Excelフォーマット設定:
                </label>
                <select
              ...
              {/* ★取込範囲指定オプション */}
              <div style={{ marginTop: '20px', padding: '16px', backgroundColor: '#f0f7ff', borderRadius: '6px', border: '1px solid #93c5e1' }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', marginBottom: '12px', fontWeight: '600' }}>
                  ...
                  />
                  <span>🎯 取込範囲を指定する（複数ページの横様式などに対応）</span>
                </label>

                {useCustomRange && (
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginTop: '16px' }}>
                    <div>
                      <label style={{ display: 'block', fontSize: '14px', fontWeight: 'bold', marginBottom: '6px', color: '#1a1a1a' }}>
                        ヘッダー行番号:
                      </label>
                      <input
                        type="number"
                      ...
                      />
                      <div style={{ fontSize: '12px', color: '#555', marginTop: '6px' }}>例: 1</div>
                    </div>
                    ...
                    <div>
                      ...
                      />
                      <div style={{ fontSize: '12px', color: '#555', marginTop: '6px' }}>例: 2</div>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        min="1"
                        value={customEndRow}
                        onChange={(e) => setCustomEndRow(e.target.value)}
                        style={{
                          width: '100%',
                          padding: '10px',
                          fontSize: '14px',
                      ...
                      />
                      <div style={{ fontSize: '12px', color: '#555', marginTop: '6px' }}>例: 500</div>
                    </div>
                  </div>
                )}
              </div>
